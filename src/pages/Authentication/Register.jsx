...
const Register = () => {
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-secondary rounded-lg shadow-lg  lg:max-w-4xl ">
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <p className="mt-3 text-2xl text-center text-text  ">
          ...
          <form onSubmit={handleSignUp}>
            ...
            {/* <div className="mt-4">
              ...
              <input
                ...
                autoComplete="photo"
                name="photo"
                className="block w-full px-4 py-2 text-text  bg-white border rounded-lg    focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300"
                type="text"
              />
            </div> */}
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="text-xs text-center text-text  uppercase  hover:underline">
          ...
          <div
            ...
            className="flex cursor-pointer items-center justify-center mt-4 text-text  transition-colors duration-300 transform border rounded-lg   hover:bg-gray-50 "
          >
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <Link
              to="/login"
              className="text-lg text-text  uppercase  hover:underline hover:text-black"
            >
              or Login
            </Link>
